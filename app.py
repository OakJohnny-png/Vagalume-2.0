...
def render_cidadao():
    ...
    # Coordenadas iniciais centralizadas em Rio do Sul, SC
    ...
    if st.button("Enviar Solicitação para a Prefeitura", type="primary"):
        ...
        # Só exige Rua/Bairro se o mapa não foi clicado
        if not lat_marcada:
        ...
        if len(campos_vazios) == 0:
            # Junta GPS com o endereço escrito
            ...
            if lat_marcada and lon_marcada:
                ...
                # Se usou o mapa mas não digitou bairro, coloca 'Bairro não informado' para o sistema rotear para 'OUTRAS ROTAS'
