...
tab_inicio, tab_finder, tab_chamados, tab_requisicoes = st.tabs(
...
with tab_inicio:
    st.markdown(
        ...
        <div style='text-align:center; padding: 2.5rem 1rem 1rem 1rem;'>
            ...
            <h1 style='font-size:clamp(2rem, 8vw, 4.5rem); color:#F5A623; margin: 0.3rem 0 0 0;
                       font-weight:800; letter-spacing:1px;'>Lúmen Bot</h1>
            <p style='font-size:clamp(0.85rem, 3vw, 1.2rem); color:#888; margin:0.4rem 0 0 0;
                      font-style:italic;'>A inteligência que acende a sua obra</p>
            <p style='font-size:clamp(0.7rem, 2.5vw, 0.95rem); color:#aaa; margin:0.3rem 0 0 0;
...
# ===========================================================================
# ABA 3: PROCESSADOR DE CHAMADOS IP
# ===========================================================================
with tab_chamados:
...
# ===========================================================================
# ABA 4: SOLICITAÇÃO DE MATERIAIS
# ===========================================================================
